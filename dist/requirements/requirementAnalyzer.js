...
exports.RequirementAnalyzer = void 0;
exports.getRequirementAnalyzer = getRequirementAnalyzer;
...
class RequirementAnalyzer {
    ...
    async analyzeRequest(userRequest, contextMessages) {
        (0, logger_1.logInfo)('RequirementAnalyzer', `Analyzing request: ${userRequest.substring(0, 100)}...`);
...
Analyze this request and provide the JSON response.`;
        try {
            ...
            const analysis = {
                ...
                clarificationsNeeded: (parsed.questions || []).map((q) => ({
                    id: (0, uuid_1.v4)(),
            ...
            (0, logger_1.logInfo)('RequirementAnalyzer', `Analysis complete. Targets: ${analysis.targets.length}, ` +
            ...
            (0, logger_1.logError)('RequirementAnalyzer', 'Failed to analyze request', error);
    ...
    parseAnalysisResponse(content) {
        try {
            ...
            (0, logger_1.logWarn)('RequirementAnalyzer', 'Failed to parse JSON response', error);
            return {};
        }
    }
    ...
    async answerClarification(clarificationId, answer) {
        ...
        const clarification = this.currentAnalysis.clarificationsNeeded.find(c => c.id === clarificationId);
        if (!clarification) {
            return null;
        }
        ...
        (0, logger_1.logInfo)('RequirementAnalyzer', `Answered clarification: ${clarification.question.substring(0, 50)}...`);
        // Check if all clarifications are answered
        const allAnswered = this.currentAnalysis.clarificationsNeeded.every(c => c.status === 'answered' || c.status === 'skipped');
        if (allAnswered) {
            ...
            (0, logger_1.logInfo)('RequirementAnalyzer', 'Re-analysis complete with all clarifications');
        }
    ...
    skipClarification(clarificationId) {
        ...
        clarification.answeredAt = new Date();
        (0, logger_1.logInfo)('RequirementAnalyzer', `Skipped clarification: ${clarification.question.substring(0, 50)}...`);
        this.currentAnalysis.updatedAt = new Date();
        return true;
    }
    needsClarification() {
...
- Risk Tolerance: ${analysis.riskTolerance}`;
    ...
    clearCurrentAnalysis() {
        ...
        (0, logger_1.logInfo)('RequirementAnalyzer', 'Cleared current analysis');
    }
}
exports.RequirementAnalyzer = RequirementAnalyzer;
function getRequirementAnalyzer() {
